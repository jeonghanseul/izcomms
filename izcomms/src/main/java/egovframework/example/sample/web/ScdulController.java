...
public class ScdulController
{
  ...
  public String scdulList(@ModelAttribute("scdulVO") ScdulVO scdulVO, HttpSession session, HttpServletRequest request, ModelMap model) throws Exception
  {
	  this.makeCalendar(scdulVO, request, model);
 ...
 * @throws Exception
 */
public String makeCalendar(@ModelAttribute("scdulVO") ScdulVO scdulVO, HttpServletRequest request, ModelMap model) throws Exception
  {
	  Calendar calendar = Calendar.getInstance();
	  if ((scdulVO.getCurYear() != null) && (scdulVO.getCurMonth() != null))
	  {
	  ...
	  System.out.println("today1 : " + calendar.getTime());
	  System.out.println("curYear1 : " + calendar.get(1));
	  System.out.println("curMonth1 : " + (calendar.get(2) + 1));
	  System.out.println("curDay1 : " + calendar.get(5));
	  
	  scdulVO.setCurYear(String.valueOf(Integer.valueOf(calendar.get(1))));
	  scdulVO.setCurMonth(String.valueOf(Integer.valueOf(calendar.get(2)+1)));
	  
	  model.addAttribute("scdulVO", scdulVO);
	  
	  
	  return "sample/makeCalendar";
  }
  ...
  public String addScdul(@ModelAttribute("scdulVO") ScdulVO scdulVO, ModelMap model)   throws Exception
  {
  ...
  public String addScdulPost(@ModelAttribute("scdulVO") ScdulVO scdulVO, BindingResult bindingResult, ModelMap model)  throws Exception
  {
  ...
  public String selectScdulView(@ModelAttribute("scdulVO") ScdulVO scdulVO, BindingResult bindingResult, ModelMap model)   throws Exception
  {
  ...
  public String updateScdul(@ModelAttribute("scdulVO") ScdulVO scdulVO, BindingResult bindingResult, ModelMap model) throws Exception
  {
    scdulVO = this.scdulService.selectScdulView(scdulVO);
    model.addAttribute("scdulVO", scdulVO);
  ...
  public String addAllot(@ModelAttribute("scdulVO") ScdulVO scdulVO, HttpServletRequest request, ModelMap model, @RequestParam String allotKey)
    throws Exception
  {
    ...
    List<MemberVO> selectMemberListByWhere= memberService.selectMemberListByWhere(request, memberVO);
    model.addAttribute("selectMemberListByWhere", selectMemberListByWhere);
