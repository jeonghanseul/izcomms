		...
		<span class="main_button2">
			<c:choose>
									<c:when test="${param.key == null}">
										<!-- 업체명만 색상변경 -->
										<span class="main_button2_type1"><a href="./scdulList.do?key=C" style="background-color:#ee4859; padding:7px 20px; color:#fff;">업체명</a></span>
										<span class="main_button2_type2"><a href="./scdulList.do?key=AD" style="background-color:#3d3d3d; padding:7px 20px; color:#fff">광고주</a></span>
										<span class="main_button2_type3"><a href="./scdulList.do?key=P" style="background-color:#3d3d3d; padding:7px 20px; color:#fff">담당자</a></span>
									</c:when>
									...
									<c:when test="${param.key == 'AD'}">
										<span class="main_button2_type1"><a href="./scdulList.do?key=C" style="background-color:#3d3d3d; padding:7px 20px; color:#fff">업체명</a></span>
										<!-- 광고주만 색상변경 -->
										<span class="main_button2_type2"><a href="./scdulList.do?key=AD" style="background-color:#ee4859; padding:7px 20px; color:#fff">광고주</a></span>
										<span class="main_button2_type3"><a href="./scdulList.do?key=P" style="background-color:#3d3d3d; padding:7px 20px; color:#fff">담당자</a></span>
									</c:when>
									<c:when test="${param.key == 'P'}">
										...
										<span class="main_button2_type2"><a href="./scdulList.do?key=AD" style="background-color:#3d3d3d; padding:7px 20px; color:#fff">광고주</a></span>
										<!-- 담당자만 색상변경 -->
										<span class="main_button2_type3"><a href="./scdulList.do?key=P" style="background-color:#ee4859; padding:7px 20px; color:#fff">담당자</a></span>
									</c:when>
								</c:choose>
		</span>
		<span>
							          		...
							          		<tr>
								                  ...
								                  <%-- month outline table --%>
								                    ...
								                    <tr height="40" width="173">
								                          <td align=left>
								                              <font color=ee4859><span style="font-weight:bold">S</span>unday</font>
								                          </td>
								                        <td align=left width="173"> <font color=444444><span style="font-weight:bold">M</span>onday</font>
</td>
								                        <td align=left width="173"> <font color=444444><span style="font-weight:bold">T</span>uesday</font>
</td>
								                        <td align=left width="173"> <font color=444444><span style="font-weight:bold">W</span>ednesday</font>
</td>
								                        <td align=left width="173"> <font color=444444><span style="font-weight:bold">T</span>hursday</font>
</td>
								                        <td align=left width="173"> <font color=444444><span style="font-weight:bold">F</span>riday</font>
</td>
								                        <td align=left width="173"><font color=3a7bcc><span style="font-weight:bold;">S</span>aturday</font>
</td>
								                    </tr>
								                    <tr>
								                              ...
								                              <tr>
								                                <c:if test="${firstDayOfWeek != '1'}">
								                                  ...
								                                  <c:forEach var="i" begin="1" end="${firstDayOfWeek-1}">
								                                    	<td width="173" height="132" class="uline" valign="top" align="right" style="padding:5">
								                                    	</td>
								                                	</c:forEach>
								                                </c:if>
								                                ...
								                                <c:if test="${lastDayOfLastWeek != '7'}">
									                                <c:forEach var="i" begin="1" end="${7-lastDayOfLastWeek}">
									                                    <td width="173" height="131" class=uline valign=top align=right style='padding:5'>
									                                    </td>
									                                </c:forEach>
								                                </c:if>                            
								                            </tr>
