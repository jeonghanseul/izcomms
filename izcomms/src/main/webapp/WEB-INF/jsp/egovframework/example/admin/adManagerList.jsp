...
<div class="bg">
			...
			<c:choose>
				<c:when test="${param.adGroup == null}">
					<div class="select_box1_type1">
						...
						<span class="con4" ><a href="./adManagerList.do?adGroup=AdCenter3">기자단</a></span>
						...
						<span class="con6"><a href="./adManagerList.do?adGroup=AdCenterTel">전화문의</a></span>
					</div>
				</c:when>
				<c:when test="${param.adGroup == ''}">
					<div class="select_box1_type2">
						<!-- 전체만 색상변경 -->
						<span class="con1_ov"><a href="./adManagerList.do" style="background-color: aqua;">전체</a></span>
						<span class="con3"><a href="./adManagerList.do?adGroup=AdCenter1">키워드광고</a></span>
						<span class="con2"><a href="./adManagerList.do?adGroup=AdCenter2">메일</a></span>
						<span class="con4"><a href="./adManagerList.do?adGroup=AdCenter3">기자단</a></span>
						<span class="con5"><a href="./adManagerList.do?adGroup=AdCenter4">브랜드검색광고</a></span>
				...
				<c:when test="${param.adGroup == 'AdCenter3'}">
					<div class="select_box1_type5">
						...
						<span class="con3"><a href="./adManagerList.do?adGroup=AdCenter1">키워드광고</a></span>
						<span class="con2"><a href="./adManagerList.do?adGroup=AdCenter2">메일</a></span>
						<span class="con4_ov"><a href="./adManagerList.do?adGroup=AdCenter3">기자단</a></span>
						<span class="con5"><a href="./adManagerList.do?adGroup=AdCenter4">브랜드검색광고</a></span>
						<span class="con6"><a href="./adManagerList.do?adGroup=AdCenter">입점 및 제휴문의</a></span>
						<span class="con6"><a href="./adManagerList.do?adGroup=AdCenterTel">전화문의</a></span>
					</div>
					...
					<div class="select_box2">
						...
						<c:choose>
							<c:when test="${param.bizAllot == null}">
								<!-- 전체만 색상 변경 -->
								<span class="text_box" style="margin-left:30px;; "><a href="./adManagerList.do"   style="background-color:#000; color:#fff;">전체</a></span>
								<span><a href="./adManagerList.do?bizAllot=Y" style="background-color:#8e8e8e; color:#fff;">배정</a></span>
								<span><a href="./adManagerList.do?bizAllot=N" style="background-color:#8e8e8e; color:#fff;">미배정</a></span>
							</c:when>
							<c:when test="${param.bizAllot == ''}">
								<!-- 전체만 색상 변경 -->
								<span style="margin-left:30px;"><a href="./adManagerList.do" style="background-color:#000; color:#fff;">전체</a></span>
								<span><a href="./adManagerList.do?bizAllot=Y" style="background-color:#8e8e8e; color:#fff;">배정</a></span>
								<span><a href="./adManagerList.do?bizAllot=N" style="background-color:#8e8e8e; color:#fff;">미배정</a></span>
							</c:when>
							<c:when test="${param.bizAllot == 'Y'}">
								<!-- 배정만 색상 변경 -->
								<span style="margin-left:30px; "><a href="./adManagerList.do" style="background-color:#8e8e8e; color:#fff; ">전체</a></span>
								<span><a href="./adManagerList.do?bizAllot=Y" style="background-color:#ff3061; color:#fff; ">배정</a></span>
								<span><a href="./adManagerList.do?bizAllot=N" style="background-color:#8e8e8e; color:#fff;">미배정</a></span>
							</c:when>
							<c:when test="${param.bizAllot == 'N'}">
								...
								<span style="margin-left:30px; "><a href="./adManagerList.do" style="background-color:#8e8e8e; color:#fff;">전체</a></span>
								<span><a href="./adManagerList.do?bizAllot=Y" style="background-color:#8e8e8e; color:#fff; ">배정</a></span>
								<span><a href="./adManagerList.do?bizAllot=N" style="background-color:#878ed3; color:#fff;">미배정</a></span>
							</c:when>
						</c:choose>
					</div>
				...
				<table width="1400"  border="0" cellspacing="0" cellpadding="0"   align="center">
					...
					<tbody>
						<tr class="mail_title">
							...
							<td>배정현황</td>
							<td>문의사항</td>
							<td style="padding-right:20px;">삭제</td>
						</tr>
		...
		<div>
			<c:choose>
				<c:when test="${param.adGroup == 'AdCenterTel'}">
					<a href="./insertAdManager.do">등록</a>
				</c:when>
			</c:choose>
		</div>
</div>
