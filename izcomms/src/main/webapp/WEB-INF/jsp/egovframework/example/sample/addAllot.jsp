					...
					<tr>
						...
						<td class="add_in_txt">
							<form:select path="member" class="type1">
								...
								<c:forEach var="selectMemberListByWhere" items="${selectMemberListByWhere}" varStatus="status">
									<form:option value="${selectMemberListByWhere.id}">${selectMemberListByWhere.name}</form:option>
								</c:forEach>
...
<%-- 								<form:option value="4">4</form:option> --%>
					...
					<tr>
						...
						<td class="add_in_txt">
							...
							<span style="color:#737373">분</span>
						</td>
					</tr>
					<tr>
			...
			<div>
				...
				<a href="./admin/adManagerList.do"><span  class="cancel">취소</span></a>
			</div>
		</form:form>
	</div>
	</div>
